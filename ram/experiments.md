...
* How to check exact memory used by a process in Linux? To the byte level granularity
...
* Can you take snapshot of the RAM usage of a program? To see what's there in the RAM, the data, the in-memory data

* Exhaust RAM in Linux using C program
* Exhaust RAM in Linux using C++ program

* Try out malloc() in C
* Try out calloc() in C
* Try out realloc() in C
* Try out free() in C
* Try out free() in C where the pointer is NOT pointing to the first byte of the dynamically allocated memory block
* Try out new() in C++
* Try out delete in C++
